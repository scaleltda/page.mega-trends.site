document.addEventListener('DOMContentLoaded', () => {
    ...
    // ====================== AUTO-CLICK DO DIGISTORE24 (AGORA CORRETO) ======================
    function executeAutoPurchase() {
        ...
        // Espera 8 segundos para o Digistore adicionar o ID da sessão
        setTimeout(() => {
            const botao = document.querySelector('#ds24-upsell-yes-button a.btn');
            if (botao) {
                botao.click();
                console.log("✅ Botão clicado automaticamente! (ID da sessão do Digistore já foi adicionado)");
            } else {
