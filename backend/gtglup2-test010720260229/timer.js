document.addEventListener('DOMContentLoaded', () => {
    ...
    // ====================== AUTO-CLICK DO DIGISTORE24 (AGORA COM TEMPO MAIOR) ======================
    function executeAutoPurchase() {
        ...
        setTimeout(() => {
            ...
            if (botao) {
                botao.click();
                console.log("✅ Botão clicado automaticamente! (esperando ID da sessão do Digistore)");
            } else {
                console.error("❌ Botão não encontrado.");
            }
        }, 8000);   // Aumentei para 8 segundos para dar tempo do ID ser criado
    }
